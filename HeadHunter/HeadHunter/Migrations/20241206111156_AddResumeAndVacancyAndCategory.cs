...
{
    /// <inheritdoc />
    public partial class AddResumeAndVacancyAndCategory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceRequiredFrom = table.Column<int>(type: "integer", nullable: false),
                    ExperienceRequiredTo = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "EducationOrCourses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InstitutionName = table.Column<string>(type: "text", nullable: false),
                    DegreeOrCertification = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationOrCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EducationOrCourses_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EducationOrCourses_ResumeId",
                table: "EducationOrCourses",
                column: "ResumeId");
